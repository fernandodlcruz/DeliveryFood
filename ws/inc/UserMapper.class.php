...
class UserMapper    {
    ...
    function createUser($postdata){
        ...
        $pdoAgent->query("INSERT INTO user (idUser, Name, PhoneNumber, Email, Usertype, Pwd, IdCuisine) 
        VALUES ( :id, :name, :phone, :email, :type, :passw, :idCuisine );");

        // postdata is declared in the login file for testing
        $pdoAgent->bind(':id',$postdata['id']);
